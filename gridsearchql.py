...
if __name__ == "__main__":
    ...
    for gamma in gammas:
        ...
        fig = plt.figure()
        plt.plot(x_axis, TargetVehicleStatistics[:, 0], label="Teleport", linewidth = 1)
        plt.plot(x_axis, TargetVehicleStatistics[:, 1], label="Collision", linewidth = 1)
        plt.xlabel('Episodes / 10')
        plt.ylabel('Events')
        plt.title('Target Vehicle Statistics with alpha: ' + str(alpha))
        plt.legend()
        plt.rcParams["figure.figsize"] = (30,6)
        fig.savefig('crashesQGamma' + str(gamma) + '.png')
        plt.close()
        ...
        fig.savefig('rewardsQGamma' + str(gamma) + '.png')
        plt.close()
        ...
        plt.legend()
        plt.rcParams["figure.figsize"] = (30,5)
        fig.savefig('meanrewardQGamma' + str(gamma) + '.png')
        plt.close()
        ...
        plt.legend()
        plt.rcParams["figure.figsize"] = (30,5)
        fig.savefig('epsilonQGamma' + str(gamma) + '.png')
        plt.close()
